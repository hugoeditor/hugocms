...
export default {
  ...
  contentQuality: {
    ...
    noAuditRun: 'No SEO audit run yet — start an audit first to see SEO findings.',
  ...
  errors: {
    ...
    'AUDIT-NO-PROJECT': 'No Hugo project is configured for this site — the audit needs public/ and content/.',

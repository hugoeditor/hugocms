...
export default {
  ...
  projectConfig: {
    ...
    shopSection: 'Shop connection (OpensourceERP)',
    shopHint:
      'OpensourceERP creates the product pages of the web shop and then triggers the build of this website. It needs the address below and a key that is valid for this website only.',
    shopEndpoint: 'Address for OpensourceERP',
    shopEndpointHint: 'Enter exactly this address in OpensourceERP — HugoCMS recognises the website by host and endpoint.',
    shopKeySet: 'Key stored (ends in …{0}), created on {1}.',
    shopKeyNone: 'No key stored — OpensourceERP cannot reach this website.',
    shopKeyShownOnce:
      'Copy the key now and enter it in OpensourceERP. It is shown this one time only; only a check value is stored.',
    shopKeyCopy: 'Copy key',
    shopKeyCreate: 'Create key',
    shopKeyReplace: 'Create new key',
    shopKeyReplaceTitle: 'Replace key?',
    shopKeyReplaceConfirm:
      'The previous key stops working immediately. OpensourceERP can reach this website again only once the new key is entered there.',
    shopKeyDelete: 'Remove key',
    shopAreas: 'OpensourceERP may write to (mount file, [shop] areas):',
    shopKeyDeleteTitle: 'Remove key?',
    shopKeyDeleteConfirm: 'OpensourceERP can no longer reach this website until a new key is created.',
    ...
    gitSection: 'Automatic version state',
    gitHint: 'Saves version states automatically during the cron build: before the build, any pending changes in the source directory are secured (if present); after publishing due releases, the version state of the publication follows. This keeps that state limited to the published files.',
  ...
  repo: {
    ...
    reset: 'Reset',
    push: 'Upload changes',
    commitMessage: 'Description of the version state',
    ...
    commitOk: 'Version state saved.',
    commitOkTagged: 'Version state {0} saved.',
    commitFail: 'The version state could not be saved.',
    pushOk: 'Changes uploaded.',
    pushFail: 'Upload failed.',
    resetTitle: 'Discard changes?',
    resetConfirm: 'All changes to tracked files that have not been saved yet will be reset to the last version state. This cannot be undone.',
    resetAction: 'Discard',
    resetOk: 'Working tree reset.',
    resetFail: 'Reset failed.',
    history: 'History',
    colSha: 'Version state',
  ...
  pagespeed: {
    ...
    where: 'Show {0} occurrence(s)',
    whereSome: 'Show {0} of {1} occurrences',
    ...
    cruxMetric: {
      ...
      EXPERIMENTAL_TIME_TO_FIRST_BYTE: 'Server response time (TTFB)',
  ...
  audit: {
    ...
    selectAll: 'Select all listed issues',
    selectedCount: '{0} selected',
    clearSelection: 'Clear selection',
    ignore: 'Ignore this issue permanently',
    unignore: 'Stop ignoring this issue',
    ignoreSelected: 'Ignore',
    unignoreSelected: 'Stop ignoring',
    ignoredMark: 'Ignored — no longer counted in any summary',
    ignoredFilter: 'Ignored',
    ignoredFilterHint: 'Show ignored issues only. They count neither in the summary nor in the e-mail report.',
    fixSelected: 'Fix with AI',
    bulkFixHint: 'One task per content file: the AI reads the file once and fixes all of its issues together.',
    bulkFixAll: 'in {0} file(s)',
    bulkFixSome: '{0} of {1} fixable, in {2} file(s)',
    bulkFixTitle: 'Let the AI work on the selection',
    bulkFixConfirm: '{0} issue(s) in {1} file(s) will be processed one after another — one task per file. In “ask first” mode the run pauses before every write.',
    bulkFixAction: 'Start',
    batchProgress: 'Bulk task: file {0} of {1} — {2}',
    batchStop: 'Stop the run',
    allSeverities: 'All',
  ...
  liveAnalysis: {
    ...
    crawl: {
      ...
      sitemapUrls: '{0} URLs',
      sitemapDocs: 'index with {0} documents',
      sitemapTruncated: 'not fully resolved (limit reached)',
      sitemapMatch: 'Sitemap match',
      sitemapInSync: 'in sync',
      sitemapDiff: 'mismatch',
      sitemapMatchDetail: '{0} found, {1} in sitemap ({2} missing, {3} orphans)',
      sitemapNa: 'n/a',
    },
    browser: {
  ...
  assistant: {
    ...
    errorRepeat: 'Occurred {0} times in a row',
    ...
    schedule: 'Set a date',
    scheduleHint: 'Store as a draft and set a publication time right away',
    scheduleTitle: 'Schedule publication',
    scheduleIntro: 'The change is stored as a draft and published at the chosen time.',
    scheduleConfirm: 'Schedule',
    scheduleLiveInfo: 'The current version stays online unchanged until the date. The swap happens at the first build after that time.',
    schedulePastHint: 'That time is in the past — please pick a future one.',
    reject: 'Reject',
  ...
  editor: {
    ...
    gotoLine: 'Go to line',
    indentLess: 'Decrease indent (Shift+Tab)',
  ...
  errors: {
    ...
    EINSECURE: 'Unencrypted connection refused.',
    'SHOP-HTTPS-REQUIRED': 'The shop connection only accepts encrypted requests (HTTPS).',
    'SHOP-KEY-NOT-SET': 'No shop connection key is stored for this website.',
    'SHOP-KEY-INVALID': 'The shop connection key is invalid.',
    'SHOP-AREAS-INVALID': 'The shop connection areas in {0} are invalid — OpensourceERP cannot transfer anything.',
    'SHOP-MANIFEST-INVALID': 'The delivery manifest is invalid.',
    'SHOP-MANIFEST-TOO-LARGE': 'The delivery contains more than {0} files.',
    'SHOP-PATH-INVALID': 'Invalid path in the delivery: {0}',
    'SHOP-PATH-DUPLICATE': 'The path appears twice in the delivery: {0}',
    'SHOP-PATH-NOT-ALLOWED': 'The path lies outside the shop connection areas: {0}',
    'SHOP-FILETYPE-NOT-ALLOWED': 'The shop connection does not accept this file type: {0}',
    'SHOP-PATH-NOT-EXPECTED': 'This file was not announced in the manifest: {0}',
    'SHOP-UPLOAD-INVALID': 'The transferred files are invalid.',
    'SHOP-FILE-TOO-LARGE': 'The file is too large: {0}',
    'SHOP-HASH-MISMATCH': 'The file arrived differently than announced: {0}',
    'SHOP-SYNC-UNKNOWN': 'This transfer is unknown or has expired.',
    'SHOP-SYNC-INCOMPLETE': 'The transfer is incomplete: {0} files are missing, e.g. {1}.',
    'SHOP-SYNC-STORE-FAILED': 'The delivery could not be stored temporarily.',
    'SHOP-THUMBNAILS-INVALID': 'The list of image names for the thumbnails is invalid.',
    'SHOP-THUMBNAILS-TOO-MANY': 'More than {0} images in one call.',
    'SHOP-THUMBNAILS-NO-GD': 'The PHP extension GD is missing — thumbnails cannot be created.',
    ...
    'GIT-NO-PROJECT': 'No Hugo project is configured for this site — versioning is missing.',
    'GIT-NOT-A-REPO': 'The Hugo project directory is not under Git versioning: {0}',
    'GIT-COMMIT-NOT-FOUND': 'Version state not found: {0}',
    'GIT-INVALID-HASH': 'Invalid version state hash: {0}',
    'GIT-INVALID-REF': 'Invalid Git reference: {0}',
    'GIT-MESSAGE-TOO-LONG': 'The description of the version state is too long (at most {0} characters).',
    ...
    'AUDIT-ISSUES-MIXED-SOURCE': 'A bulk task covers exactly one content file ({0} instead of {1}).',
    'AUDIT-FIX-TOO-MANY': 'Too many issues for one task — {0} at most.',
    'AUDIT-IGNORE-LIMIT': 'The ignore list is full ({0} entries). Exclude whole directories via the project settings instead.',
    'AUDIT-IGNORE-KEY-INVALID': 'Unusable issue key: {0}',
    ...
    'USER-FILETYPE-INVALID': 'The file type “{0}” is not allowed (letters and digits only, no dot).',

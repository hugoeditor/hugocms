...
export default {
  ...
  projectConfig: {
    ...
    shopSection: 'Shop-Anbindung (OpensourceERP)',
    shopHint:
      'OpensourceERP erzeugt die Produktseiten des Webshops und stößt danach den Bau dieser Webseite an. Dafür braucht es die Adresse unten und einen Schlüssel, der nur für diese Webseite gilt.',
    shopEndpoint: 'Adresse für OpensourceERP',
    shopEndpointHint: 'Genau diese Adresse in OpensourceERP eintragen — HugoCMS erkennt die Webseite an Host und Endpunkt.',
    shopKeySet: 'Schlüssel hinterlegt (endet auf …{0}), erzeugt am {1}.',
    shopKeyNone: 'Kein Schlüssel hinterlegt — OpensourceERP kann diese Webseite nicht ansprechen.',
    shopKeyShownOnce:
      'Den Schlüssel jetzt kopieren und in OpensourceERP eintragen. Er wird nur dieses eine Mal angezeigt; gespeichert ist nur ein Prüfwert.',
    shopKeyCopy: 'Schlüssel kopieren',
    shopKeyCreate: 'Schlüssel erzeugen',
    shopKeyReplace: 'Neuen Schlüssel erzeugen',
    shopKeyReplaceTitle: 'Schlüssel ersetzen?',
    shopKeyReplaceConfirm:
      'Der bisherige Schlüssel gilt danach sofort nicht mehr. OpensourceERP erreicht diese Webseite erst wieder, wenn dort der neue eingetragen ist.',
    shopKeyDelete: 'Schlüssel entfernen',
    shopAreas: 'OpensourceERP darf beschreiben (Mount-Datei, [shop] areas):',
    shopKeyDeleteTitle: 'Schlüssel entfernen?',
    shopKeyDeleteConfirm: 'OpensourceERP kann diese Webseite danach nicht mehr ansprechen, bis ein neuer Schlüssel erzeugt ist.',
    ...
    gitSection: 'Automatischer Versionsstand',
    gitHint: 'Sichert beim Cron-Build automatisch Versionsstände: vor dem Build werden offene Änderungen im Quellverzeichnis gesichert (falls vorhanden), nach der Veröffentlichung fälliger Freigaben folgt der Versionsstand der Veröffentlichung. So bleibt dieser auf die publizierten Dateien beschränkt.',
  ...
  pro: {
    ...
    feature: {
      git: {
        ...
        points: [
          'Änderungen als Versionsstand sichern — mit Beschreibung und Zeitpunkt',
          ...
          'Stände zu einer entfernten Gegenstelle hochladen',
        ],
      },
      audit: {
  ...
  repo: {
    ...
    commitMessage: 'Beschreibung des Versionsstands',
    ...
    commitOk: 'Versionsstand gesichert.',
    commitOkTagged: 'Versionsstand {0} gesichert.',
    commitFail: 'Versionsstand konnte nicht gesichert werden.',
    pushOk: 'Änderungen hochgeladen.',
    pushFail: 'Hochladen fehlgeschlagen.',
    resetTitle: 'Änderungen verwerfen?',
    resetConfirm: 'Alle noch nicht gesicherten Änderungen an verfolgten Dateien werden auf den letzten Versionsstand zurückgesetzt. Das lässt sich nicht rückgängig machen.',
    resetAction: 'Verwerfen',
    resetOk: 'Arbeitsbaum zurückgesetzt.',
    resetFail: 'Zurücksetzen fehlgeschlagen.',
    history: 'Verlauf',
    colSha: 'Versionsstand',
    colMessage: 'Beschreibung',
    colAuthor: 'Autor',
    colDate: 'Datum',
    prev: 'Zurück',
    next: 'Weiter',
  ...
  audit: {
    ...
    selectAll: 'Alle angezeigten Funde auswählen',
    selectedCount: '{0} ausgewählt',
    clearSelection: 'Auswahl aufheben',
    ignore: 'Diesen Fund dauerhaft ignorieren',
    unignore: 'Diesen Fund wieder aufnehmen',
    ignoreSelected: 'Ignorieren',
    unignoreSelected: 'Wieder aufnehmen',
    ignoredMark: 'Ignoriert — zählt in keiner Zusammenfassung mehr mit',
    ignoredFilter: 'Ignoriert',
    ignoredFilterHint: 'Nur ignorierte Funde zeigen. Sie zählen weder in der Zusammenfassung noch im E-Mail-Bericht mit.',
    fixSelected: 'Mit KI bearbeiten',
    bulkFixHint: 'Je Content-Datei ein Auftrag: Die KI liest die Datei einmal und behebt alle ihre Funde zusammen.',
    bulkFixAll: 'in {0} Datei(en)',
    bulkFixSome: '{0} von {1} bearbeitbar, in {2} Datei(en)',
    bulkFixTitle: 'Auswahl von der KI bearbeiten lassen',
    bulkFixConfirm: '{0} Fund(e) in {1} Datei(en) werden nacheinander bearbeitet — je Datei ein Auftrag. Im Modus „Nachfragen" hält die Reihe vor jedem Schreiben an.',
    bulkFixAction: 'Starten',
    batchProgress: 'Sammelauftrag: Datei {0} von {1} — {2}',
    batchStop: 'Reihe anhalten',
    allSeverities: 'Alle',
  ...
  liveAnalysis: {
    ...
    crawl: {
      ...
      sitemapUrls: '{0} URLs',
      sitemapDocs: 'Index mit {0} Dokumenten',
      sitemapTruncated: 'nicht vollständig aufgelöst (Obergrenze erreicht)',
      sitemapMatch: 'Sitemap-Abgleich',
      sitemapInSync: 'deckungsgleich',
      sitemapDiff: 'Abweichung',
      sitemapMatchDetail: '{0} gefunden, {1} in Sitemap ({2} fehlen, {3} verwaist)',
      sitemapNa: 'n/v',
    },
    browser: {
  ...
  assistant: {
    ...
    approveLater: 'Später veröffentlichen',
    approveLaterHint: 'Als Entwurf in die Freigabe legen — die Live-Datei bleibt unverändert. In der Warteschlange lässt sich der Entwurf freigeben oder terminieren.',
    draftStashed: 'Als Entwurf zur Freigabe abgelegt — in der Warteschlange freigeben oder terminieren.',
    schedule: 'Termin festlegen',
    scheduleHint: 'Als Entwurf ablegen und gleich einen Veröffentlichungszeitpunkt festlegen',
    scheduleTitle: 'Veröffentlichung terminieren',
    scheduleIntro: 'Die Änderung wird als Entwurf abgelegt und zum gewählten Zeitpunkt veröffentlicht.',
    scheduleConfirm: 'Terminieren',
    scheduleLiveInfo: 'Die bisherige Fassung bleibt bis zum Termin unverändert online. Der Austausch geschieht beim ersten Bauen nach dem Zeitpunkt.',
    schedulePastHint: 'Der Zeitpunkt liegt in der Vergangenheit — bitte einen künftigen wählen.',
    reject: 'Ablehnen',
  ...
  editor: {
    ...
    indentLess: 'Einzug verringern (Umschalt+Tab)',
  ...
  errors: {
    ...
    EINSECURE: 'Unverschlüsselte Verbindung abgelehnt.',
    'SHOP-HTTPS-REQUIRED': 'Die Shop-Anbindung nimmt nur verschlüsselte Aufrufe (HTTPS) an.',
    'SHOP-KEY-NOT-SET': 'Für diese Webseite ist kein Schlüssel der Shop-Anbindung hinterlegt.',
    'SHOP-KEY-INVALID': 'Der Schlüssel der Shop-Anbindung ist ungültig.',
    'SHOP-AREAS-INVALID': 'Die Bereiche der Shop-Anbindung in {0} sind ungültig — OpensourceERP kann nichts übertragen.',
    'SHOP-MANIFEST-INVALID': 'Das Verzeichnis der Lieferung ist ungültig.',
    'SHOP-MANIFEST-TOO-LARGE': 'Die Lieferung enthält mehr als {0} Dateien.',
    'SHOP-PATH-INVALID': 'Ungültiger Pfad in der Lieferung: {0}',
    'SHOP-PATH-DUPLICATE': 'Der Pfad steht zweimal in der Lieferung: {0}',
    'SHOP-PATH-NOT-ALLOWED': 'Der Pfad liegt außerhalb der Bereiche der Shop-Anbindung: {0}',
    'SHOP-FILETYPE-NOT-ALLOWED': 'Diese Dateiart nimmt die Shop-Anbindung nicht an: {0}',
    'SHOP-PATH-NOT-EXPECTED': 'Diese Datei war im Abgleich nicht angekündigt: {0}',
    'SHOP-UPLOAD-INVALID': 'Die übertragenen Dateien sind ungültig.',
    'SHOP-FILE-TOO-LARGE': 'Die Datei ist zu groß: {0}',
    'SHOP-HASH-MISMATCH': 'Die Datei kam anders an als angekündigt: {0}',
    'SHOP-SYNC-UNKNOWN': 'Diese Übertragung ist unbekannt oder abgelaufen.',
    'SHOP-SYNC-INCOMPLETE': 'Die Übertragung ist unvollständig: {0} Dateien fehlen, etwa {1}.',
    'SHOP-SYNC-STORE-FAILED': 'Die Lieferung ließ sich nicht zwischenspeichern.',
    'SHOP-THUMBNAILS-INVALID': 'Die Liste der Bildnamen für die Vorschaubilder ist ungültig.',
    'SHOP-THUMBNAILS-TOO-MANY': 'Mehr als {0} Bilder in einem Aufruf.',
    'SHOP-THUMBNAILS-NO-GD': 'Die PHP-Erweiterung GD fehlt — Vorschaubilder lassen sich nicht erzeugen.',
    ...
    'GIT-NO-PROJECT': 'Für diese Webseite ist kein Hugo-Projekt konfiguriert — die Versionierung fehlt.',
    'GIT-NOT-A-REPO': 'Das Hugo-Projektverzeichnis steht nicht unter Git-Versionierung: {0}',
    'GIT-COMMIT-NOT-FOUND': 'Versionsstand nicht gefunden: {0}',
    'GIT-INVALID-HASH': 'Ungültiger Hash des Versionsstands: {0}',
    'GIT-INVALID-REF': 'Ungültige Git-Referenz: {0}',
    'GIT-MESSAGE-TOO-LONG': 'Die Beschreibung des Versionsstands ist zu lang (höchstens {0} Zeichen).',
    ...
    'AUDIT-ISSUES-MIXED-SOURCE': 'Ein Sammelauftrag umfasst genau eine Content-Datei ({0} statt {1}).',
    'AUDIT-FIX-TOO-MANY': 'Zu viele Funde für einen Auftrag — höchstens {0} auf einmal.',
    'AUDIT-IGNORE-LIMIT': 'Die Ignorierliste ist voll ({0} Einträge). Schließe ganze Verzeichnisse besser über die Projekteinstellungen aus.',
    'AUDIT-IGNORE-KEY-INVALID': 'Unbrauchbare Fund-Kennung: {0}',
    ...
    'USER-FILETYPE-INVALID': 'Der Dateityp „{0}“ ist unzulässig (nur Buchstaben und Ziffern, ohne Punkt).',

...
require '../../../backend/editor.inc.php';
require '../../../backend/editor.restricted.php';  //Angedacht: der Admin-User kann alles, andere nur bestimmte Dateien/Modies (Easy und Normal), der zuerst angelegte User wird Admin

$cmsroot_dir = __DIR__.'/../../../../../'; // CMS root directory (Working directory)
